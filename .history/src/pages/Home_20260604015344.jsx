...
import heroMain from "../assets/home/hero-main.svg";
import heroPolaroid from "../assets/home/hero-polaroid.svg";
...
import vanity from "../assets/logos/vanity-fair.svg";
...
function LogoStrip() {
  ...
  useEffect(() => {
    ...
    let x = 0;
    let raf;
    const speed = 3.1; // px/frame — artırırsan hızlanır
