...
function Create() {
  ...
  if (wordCount > 2) {
    setTitleError(
      "Perfume name can contain a maximum of 2 words."
    );
    return;
  }
    ...
    <div className="create-page page-enter">
      ...
      <section className="tag-section">
       ...
       <div className="tag-wrapper">
        <img className="tag-img" src={tagImage} alt="Tag" />

        <p className="tag-text">
          This fragrance is not designed to please, but to reflect.
        </p>
      </div>
