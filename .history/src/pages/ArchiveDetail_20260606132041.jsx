...
function ArchiveDetail() {
  ...
  if (loading) {
    return (
      <div className="archive-detail-page page-enter">
        <Navbar />
...
function formatStaticMemory(item) {
  return {
    ...
    perfumeImage: item.perfumeImage || null,
    memoryText:
      item.memoryText ||
    ...
    notes: {
      top: item.notes?.top || [grass, green leaves],
      heart: item.notes?.heart || [lily],
      base: item.notes?.base || [soft musk, pine, iris],
    },
