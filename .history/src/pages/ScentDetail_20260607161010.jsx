...
import applePieAddedCart from "../assets/scents/apple-pie-added-cart.svg";
import applePieCart from "../assets/cart/apple-pie-cart.svg";
...
const scentCartData = {
  ...
  title: "Apple Pie",
  price: 95,
  panelImage: applePieAddedCart,
  cartImage: applePieCart,
  notes: {
    top: ["lemon", "yuzu", "aldehydes"],
    heart: ["milk accord", "angelica", "cinnamon", "marzipan"],
    base: ["sandalwood", "cedarwood", "skin musk"],
  },
},
  "morning-crust": {
    title: "Morning Crust",
