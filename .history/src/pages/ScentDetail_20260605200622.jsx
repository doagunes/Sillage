...
const toggleInfo = (section) => {
  ...
  <div className="scent-accordion-item">
    ...
    {openInfo === "how" && (
      <div className="scent-accordion-content">
        <p>
          Apply your fragrance to the pulse points of the body wrists, neck,
          and behind the ears. These areas allow the scent to develop naturally
          throughout the day.
        </p>
      </div>
    )}
  ...
  <div className="scent-accordion-item">
    ...
    {openInfo === "purchase" && (
      <div className="scent-accordion-content">
        <p>
          Sillage fragrances can be created and purchased directly through our
          website. Begin by writing your memory, selecting your notes, and
          designing your personalized fragrance.
        </p>
      </div>
    )}
  </div>
    ...
    {openInfo === "production" && (
      <div className="scent-accordion-content">
        <p>
          ...
          Every bottle is filled, labeled, and packaged individually.
        </p>
      </div>
    )}
  </div>
