...
import bagIcon from "../assets/navbar/bag-icon.svg";
import instagramIcon from "../assets/navbar/instagram-icon.svg";
  ...
  return (
    <header className="navbar">
      ...
      <div className="nav-icons">
        ...
        <a
          href="https://www.instagram.com/thisis.sillage?igsh=MTljbGZkZDJpeHc1bQ=="
          target="_blank"
          rel="noreferrer"
