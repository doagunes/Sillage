...
function CartPerfumePreview({ item }) {
  ...
  /*
    Hazır scent ürünleri için:
    salt-air-cart.svg, morning-crust-cart.svg, midnight-balcony-cart.svg
    direkt gösterilir.

    Dynamic create ürünleri için:
    eski cart-base sistemi çalışmaya devam eder.
  */
