...
app.post("/api/memories", upload.single("memoryImage"), (req, res) => {
  const { userId, title, memoryText, topNotes, heartNotes, baseNotes } = req.body;
...
app.post("/api/cart", (req, res) => {
  ...
  db.run(
    ...
    (userId, title, concentration, volume, packagingType, price, topNotes, heartNotes, baseNotes, packageImage, quantity)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `,
    [
      userId,
